...
const followersData = [
    { id: '1', name: 'Steven Naranjo', avatar: 'https://avatar.iran.liara.run/public/13', isFollowing: true },
    { id: '2', name: 'Dinosaurio Feliz', avatar: 'https://avatar.iran.liara.run/public/43', isFollowing: true },
    { id: '3', name: 'Sneider Galindo', avatar: 'https://avatar.iran.liara.run/public/5', isFollowing: true },
    { id: '4', name: 'Valeria Corral', avatar: 'https://avatar.iran.liara.run/public/65', isFollowing: true },
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                />
                <Text style={styles.followerCount}>seguidos: {filteredFollowers.length} usuarios</Text>
            </View>
