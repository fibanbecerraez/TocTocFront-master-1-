...
export default function App() {
    ...
    const handleSignup = async () => {
        ...
        try {
            const result = await signUp(firstName, lastName, email, password, selectedOption);
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.disclaimer}>Al hacer clic en "Registrarte", aceptas nuestras Condiciones, la Política de privacidad y la Política de cookies. Es posible que te enviemos notificaciones por SMS, que puedes desactivar cuando quieras.</Text>
